...
const SecurityScan = () => {
   ...
   <form onSubmit={handleSubmit(onSubmit)}>
    ...
    <div className="media mx-auto p-4 pt-2 flex gap-6">
          {/* Shipments start */}
          <Card heading="Security Scan Manifest">
            <div className="flex gap-6">
              <div className="flex-1 flex flex-col gap-3 ">
                <div className="flex-1 flex items-center gap-4 w-full">
                  <label className="label">
                    Pickup Id <span className="text-[#FF0000]">*</span>
                  </label>
                ...
                <div className="flex-1 flex items-center gap-3 w-full">
                  <label className="label">
                  Courier Code# <span className="text-[#FF0000]">*</span>
                  </label>
                  <div className="flex flex-col flex-1">
                    <input
                      type="number"
                ...
                <div className="flex-1 flex items-center gap-4 w-full">
                  <label className="label">
                    Shift Type <span className="text-[#FF0000]">*</span>
                  </label>
                  <select
                    type="text"
